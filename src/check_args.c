...
/*   Updated: 2024/06/27 18:01:18 by yohurteb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "pipex.h"

static void	excve_and_free(char **cmd, char **cmd_free)
{
...
static void	check_no_env_but_path(char **env, char **argv, int pipefd[])
{
	char	**c1;
	char	**c2;
